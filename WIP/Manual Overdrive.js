...
/**
 * 
 * Want some background music to listen to while playing? Check this out: https://www.youtube.com/watch?v=y_gknRMZ-OU
 * 
 * 
...
/* ---------- CHARACTERS --------- */
var pentium = function(x, y, charSize) {
    fill(0, 0, 0);
...
var skylake = function(x, y, charSize) {
    fill(255, 0, 0);
    rect(x, y, charSize, charSize * 1.2);
    fill(255, 255, 255);
    // Blinking
    if(frameCount % 150 > 8) {
        ellipse(x + charSize * 1/4, y + charSize * 1/4, charSize * 1/5, charSize * 1/5);
...
var menuSlide = function() {
    ...
    myTextWeight(3);
    myText("MAINFRAME", 55, 50);
    myTextSize(35);
    myTextWeight(4);
    myTextFill(color(255, 0, 0));
    myText("OVERDRIVE", 105 + sin(frameCount * 10) * 5, 110);
